...
[CreateAssetMenu(fileName = "Enemy Weapon", menuName = "Weapons/New Enemy Weapon", order = 0)]
public class EnemyWeapon : ScriptableObject
{
    public EnemyLeftWeaponType weaponTypeL;
    public EnemyRightWeaponType weaponTypeR;
